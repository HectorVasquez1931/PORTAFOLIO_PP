...
Todos los nombres de variables, de funciones, structus y enum.
...
Estructuras en el stack que se crean cuando se llama una función y se destruyen al terminar. En addBook se crea un marco con los parámetros library y bookCount, count y variables locales como new_book.
...
Link GitHub:  
https://github.com/HectorVasquez1931/PORTAFOLIO_PP  
